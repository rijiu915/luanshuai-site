...
export default function NewEditor({ imageUrl }: { imageUrl: string }) {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => router.push('/')} className="px-6 py-2 bg-blue-600 text-white rounded-lg">返回首页</button>
        </div>
      </div>
    );
  }
